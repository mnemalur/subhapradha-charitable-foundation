              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="newsletter" className="ml-2 block text-sm text-gray-700">
                    I would like to receive updates about SCO&apos;s programs and impact stories
                  </label>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">info@sco.org</p>
                      </div>
                    </div>
                    <div className="flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Quick answers to common questions about getting in touch with SCO
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Can I schedule a meeting?</h3>
              <p className="text-gray-600">
                Absolutely! We&apos;d be happy to schedule a meeting to discuss partnerships, 
                volunteer opportunities, or any other collaboration possibilities.
              </p>
            </div>

            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Do you offer tours of your facilities?</h3>
              <p className="text-gray-600">
                Yes, we offer guided tours of our facilities by appointment. Please contact us 
                at least one week in advance to schedule your visit.
              </p>
            </div>

            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">How can I volunteer?</h3>
              <p className="text-gray-600">
                We have various volunteer opportunities available. Please fill out our contact form 
                with your interests and availability, and we&apos;ll get back to you with options.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-blue-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">
            ...
            we&apos;re here to help you make a difference in communities that need it most.
          </p>
