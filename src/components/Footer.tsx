          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <div className="ml-3">
                ...
                <div className="text-sm text-blue-400 font-semibold">SCO</div>
              </div>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Dedicated to serving communities through compassionate charitable initiatives, 
              education, and sustainable development programs. Together, we build hope and create lasting positive change.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Subhapradha Charitable Organization (SCO). All rights reserved.
            </p>
